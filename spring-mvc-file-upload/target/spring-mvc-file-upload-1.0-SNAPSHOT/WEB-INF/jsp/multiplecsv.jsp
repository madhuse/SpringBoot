...
<div class="wrapper">
  ...
  <div class="row">
      ...
      <form role="form" action="createtable" id="createselection"  name="myform" onsubmit="return validateForm()" method="post">
								...
								<input required="required" id="selection"  type="text" name="${filename}[]" class="form-control" value=${column } > 
								</div>
								
								<div class="col-xs-4 nopadding" title="Column Data= ${coldata[status.index]}">
								<select did="${filename}${column}"   name="datatypes[]" class="form-control datatype select2" >
